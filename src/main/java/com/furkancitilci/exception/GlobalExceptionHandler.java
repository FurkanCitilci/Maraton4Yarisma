...
import static com.furkancitilci.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    /**
     * ExceptionHandler -> Kendisine verilen sınıfın uygulama içinde istisna fırlamtmsı durumunda devreye girer
     * ve o hatayı yakalar
     * @param exception
     * @return
     */
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerSpringMonoException(YarismaException exception){
